	...
	<div style=" margin-top:10px;color:#FFF; font-size:23px; text-align:left">
		<font size="3" color="#FFFF00">
			...
			if (mysqli_query($con, $sql)) {
				echo "[*]...................Old database 'SECURITY' purged if exists";
				echo "<br><br>\n";
			} else {
			...
			if (mysqli_query($con, $sql)) {
				echo "[*]...................Creating New database 'SECURITY' successfully";
				echo "<br><br>\n";
			} else {
			...
			if (mysqli_query($con, $sql)) {
				echo "[*]...................Creating New Table 'USERS' successfully";
				echo "<br><br>\n";
			} else {
		...
		PRIMARY KEY (id)
			...
			if (mysqli_query($con, $sql)) {
				echo "[*]...................Creating New Table 'EMAILS' successfully";
				echo "<br><br>\n";
			} else {
				echo "[*]...................Error creating Table: " . mysqli_error($con);
				echo "<br><br>\n";
		...
		PRIMARY KEY (id)
			...
			if (mysqli_query($con, $sql)) {
				echo "[*]...................Inserted data correctly  into table 'EMAILS'";
				echo "<br><br>\n";
			} else {
				echo "[*]...................Error inserting data: " . mysqli_error($con);
				echo "<br><br>\n";
